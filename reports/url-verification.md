...
| Input URL | Status | Title | Canonical | Critical Failures |
| --- | --- | --- | --- | --- |
| https://www.distilledfunding.com/ | 200 | Moonshine Capital | Funding Solutions in Northern Virginia & Washington D.C. | https://www.distilledfunding.com | none |
| https://www.distilledfunding.com/privacy-policy | 200 | Privacy Policy | Moonshine Capital | https://www.distilledfunding.com/privacy-policy | none |
| https://www.distilledfunding.com/revenuebased | 200 | Get Revenue-Based Financing Fast | Moonshine Capital | https://www.distilledfunding.com/revenuebased | none |
| https://www.distilledfunding.com/post/warp-speed-mortgage-review | 200 | How 'Warp Speed Mortgage' is Revolutionizing the Home Loan Industry | https://www.distilledfunding.com/post/warp-speed-mortgage-review | none |
| https://www.distilledfunding.com/industries/wix-seller-financing | 200 | Wix Seller Financing (2026): Funding Options for Wix Stores (Fast + Realistic) | https://www.distilledfunding.com/industries/wix-seller-financing | none |

## Details

### https://www.distilledfunding.com/

- Final URL: `https://www.distilledfunding.com/`
- Status code: `200`
- Title: Moonshine Capital | Funding Solutions in Northern Virginia & Washington D.C.
- Meta description: Moonshine Capital: Funding Solutions for Creators in Northern Virginia and Washington D.C. Pre-qualify now!
- Canonical: https://www.distilledfunding.com
- Robots meta: (missing)
- First H1: <span style="letter-spacing:normal;" class="wixui-rich-text__text"><span class="color_11 wixui-rich-text__text"><span style="font-weight:700;" class="wixui-rich-text__text">Fuel Your Dreams with the Right Funding</span></span></span>
- JSON-LD count: `2`
- JSON-LD @types: LocalBusiness, PostalAddress, WebSite
- Critical failures: (none)
- Visible text (first 500 chars): Moonshine Capital | Funding Solutions in Northern Virginia & Washington D.C. top of page Moonshine Capital Business Funding Revenue-Based Financing Instant Micro Funding Lines of Credit (LOC) Equipment Financing Merchant Cash Advance Invoice Financing 401(k) Business Financing SBA Loans Apply Now Real Estate Fix and Flip Rental Loans Vacation Rentals Construction Multi-Family Industries Agriculture Business-to-Business Construction Commercial Real Estate Ecommerce Business Healthcare Wix Seller 
...
- Final URL: `https://www.distilledfunding.com/revenuebased`
- Status code: `200`
- Title: Get Revenue-Based Financing Fast | Moonshine Capital
- Meta description: Explore revenue based financing options with Moonshine Capital! Fast funding, simple qualifications, and top providers for your business.
...
- Final URL: `https://www.distilledfunding.com/post/warp-speed-mortgage-review`
- Status code: `200`
- Title: How 'Warp Speed Mortgage' is Revolutionizing the Home Loan Industry
...
- Critical failures: (none)
- Visible text (first 500 chars): How 'Warp Speed Mortgage' is Revolutionizing the Home Loan Industry top of page Moonshine Capital Business Funding Revenue-Based Financing Instant Micro Funding Lines of Credit (LOC) Equipment Financing Merchant Cash Advance Invoice Financing 401(k) Business Financing SBA Loans Apply Now Real Estate Fix and Flip Rental Loans Vacation Rentals Construction Multi-Family Industries Agriculture Business-to-Business Construction Commercial Real Estate Ecommerce Business Healthcare Wix Seller Financing

### https://www.distilledfunding.com/industries/wix-seller-financing

- Final URL: `https://www.distilledfunding.com/industries/wix-seller-financing`
- Status code: `200`
